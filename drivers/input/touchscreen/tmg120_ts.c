...
static int __devinit tmg120_ts_probe(struct i2c_client *client,
...
static __devexit int tmg120_ts_remove(struct i2c_client *client)
{
...
static struct i2c_driver tmg120_ts_driver = {
	...
	.remove		= __devexit_p(tmg120_ts_remove),
};
